...
# sleep(2)
# box2 = driver.find_element(By.ID, 'listbox_totlbf_container')
# box2.find_element(By.TAG_NAME, 'a').click()
# sleep(2)
# driver.find_element(By.ID, 'chip-return-tlbf').click()
# sleep(2)
# outboudndatepicker = driver.find_element(By.CSS_SELECTOR, 'div[class="outbound display-group-wrapper"]')
